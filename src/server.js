...
createServer({
    ...
    routes() {
        this.namespace = "api"
        this.logging = false
        this.passthrough("https://firestore.googleapis.com/**") //mirage js intercepts all outgoing fetch requests, so we need this passthrough to allow requests to firestore
